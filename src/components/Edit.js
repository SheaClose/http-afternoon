...
class Edit extends Component {
  ...
  componentWillMount() {
    axios
      ...
      .then(response => {
        const { title, subTitle, image, text } = response.data;
        this.setState({ title, subTitle, image, text });
      })
      .catch(console.log);
  }
  updatePost() {
    ...
    axios
      .put(`/api/blog/${this.props.match.params.id}`, obj)
      .then(_ => this.props.history.push(`/blog/${this.props.match.params.id}`))
      .catch(console.log);
  }
  deletePost() {
    axios
